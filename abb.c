...
bool abb_guardar_auxiliar(const abb_t *arbol, abb_nodo_t *nodo, const char *clave, void *valor){
...
bool abb_guardar(abb_t *arbol, const char *clave, void *dato){
    if(!arbol->raiz) arbol->raiz = nodo_crear(clave, dato, NULL);
    else{
...
void *abb_borrar(abb_t *arbol, const char *clave){
    abb_nodo_t *a_borrar = abb_obtener(arbol, clave);
